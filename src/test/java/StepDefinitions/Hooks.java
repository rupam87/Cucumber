...
import Utils.CustomEventListenerPlugin;
...
public class Hooks {
    ...
    public static ThreadLocal<DIContext> diContextThreadLocal = new ThreadLocal<DIContext>();
    ...
    public void beforeUIHooks(Scenario scenario) throws Exception {
        ...
        try {
            ...
            // Initiate Threadlocal make use of scenario context in custom event listener
            diContextThreadLocal.set(this.scenarioContext);
